...
(
    ...
    InputCostPer1kTokens   Float64,    -- USD per 1K input tokens
    OutputCostPer1kTokens  Float64,    -- USD per 1K output tokens
...
-- Meta Llama (via vLLM self-hosted — $0 inference cost)
